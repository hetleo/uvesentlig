...
export default function BooksAdmin({ initialBooks }: BooksAdminProps) {
  ...
  return (
    <div>
        ...
        <div style={{ background: "#15110e", border: "0.6px solid #3d3630", padding: 16, marginBottom: 20 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 10 }}>
            ...
            <div>
              ...
              <input type="text" value={form.location} onChange={(e) => setForm((f) => ({ ...f, location: e.target.value }))} style={{ ...inputStyle, width: "100%" }} />
            </div>
            <div>
      ...
      {/* Books list */}
      <div>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1.2fr 0.5fr 0.8fr 0.8fr", columnGap: 12, paddingBottom: 6, borderBottom: "0.6px solid #4a423a", fontSize: "0.58rem", color: "#6a6155", letterSpacing: "0.05em" }}>
          <span>TITTEL</span><span>FORFATTER</span><span>ÅR</span><span>STATUS</span><span>PLASSERING</span>
        </div>
        {books.map((b) => (
          <div key={b.id} style={{ display: "grid", gridTemplateColumns: "2fr 1.2fr 0.5fr 0.8fr 0.8fr", columnGap: 12, padding: "5px 0", borderBottom: "0.4px solid #2a2520", alignItems: "center" }}>
